...
class Connection extends EventEmitter {
  ...
  async readNextRequest() {
    ...
    let requestLength;
    try {
      console.log('decoding request length', this.readerBuffer.toString('hex'));
      // eslint-disable-next-line no-bitwise
    ...
    console.log('varint length', varintLength);
    ...
    let request;
    try {
      console.log('decoding the request');
    ...
    console.log('request decoded', request);
