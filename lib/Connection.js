...
class Connection extends EventEmitter {
  ...
  async readNextRequest() {
    ...
    try {
      ...
      varintLength = varint.decode.bytes;
      ...
      const requestBufferLength = (varintLength + requestLength) || this.readerBuffer.length;
      const requestBuffer = this.readerBuffer.slice(0, requestBufferLength);
