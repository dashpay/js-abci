...
const finalizeBlockRequest = new Request({
  finalizeBlock: new RequestFinalizeBlock({
    txs: [],
    byzantineValidators: [],
    decidedLastCommit: new CommitInfo({ thresholdVoteExtensions: [] }),
    hash: Buffer.from('79fa39557d29f9d0f1e40cc20c7e40ae69c1f582bc514c30395d0f65bcd5e607', 'hex'),
    height: new Long(1, 0, true),
    time: new Timestamp({
      seconds: new Long(1656943599, 0, false),
      nanos: 474570673,
    }),
...
const infoRequest = new Request({
  info: new RequestInfo({
    ...
    abciVersion: '',
    blockVersion: new Long(0, 0, true),
    p2pVersion: new Long(0, 0, true),
  }),
});
